...
class JournalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journal" do
    assert_difference('Journal.count') do
      post journals_url, params: { journal: { date: @journal.date, entry: @journal.entry, title: @journal.title } }
    end
  ...
  test "should update journal" do
    patch journal_url(@journal), params: { journal: { date: @journal.date, entry: @journal.entry, title: @journal.title } }
